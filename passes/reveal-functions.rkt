...
(define (set-func-names def-arg-cnt-map)
    (lambda (exp)
        (match exp
            ...
            [(If e1 e2 e3) (If ((set-func-names def-arg-cnt-map) e1) ((set-func-names def-arg-cnt-map) e2) ((set-func-names def-arg-cnt-map) e3))]
            [(Let x e body) (Let x ((set-func-names def-arg-cnt-map) e) ((set-func-names def-arg-cnt-map) body))]
            ...
            [(WhileLoop cnd body) (WhileLoop ((set-func-names def-arg-cnt-map) cnd) ((set-func-names def-arg-cnt-map) body))]
            [(Apply func args)
